...
int main (int argc, const char * argv[]) {    
   ...
   printf("%%%%%% The speedup(SerialTimeCost / ParallelTimeCost) when using %d threads is %lf\n", NTHREADS, scost / pcost); 
   printf("%%%%%% The efficiency(Speedup / NumProcessorCores) when using %d threads is %lf\n", NTHREADS, scost / pcost / NTHREADS); 
